...
class execute :
    ...
    def get_function_7():
        return str(self.instruction[0:7])
    def get_function_3():
        return str(self.instruction[7:12])    
    ...
    def DecodeR(self):
        ...
        self.funtion_7 = self.get_function_7() 
        self.Source_reg_2 =self.Rsource_2()
        self.dest_reg_1 = str(self.instruction[20:25])
        self.source_reg_1 = str(self.instruction[12:17])
        self.RB = self.Register.read(self.Source_reg_2)  # Loading value of register at Source_reg_2
        self.RA = self.Register.read(self.source_reg_1)  # Loading value of register at rs1
        self.funtion_3 = self.get_function_3()
        self.muxY = 0
        """
    ...
    def DecodeI(self):
        ...
        if self.OP_code == "0000011" and self.funtion_3 == "010"  :
            ...
            no_match_found=0
            self.muxY=1
            self.ALU(1)    #all load ins lb, lh, lw
    ...
    def DecodeS(self):
        ...
        """
        self.Source_reg_2 = str(self.instruction[7:12])
        self.RB = self.Register.read(self.Source_reg_2)
        self.source_reg_1 = str(self.instruction[12:17])
        self.funtion_3 = str(self.instruction[17:20])
        self.RA = self.Register.read(self.source_reg_1)
        """
        ...
        print("source_reg_1:",self.source_reg_1)
        print("Source_reg_2:",self.Source_reg_2)
        print("RA:",self.RA)
        print("RB:",self.RB)
        print("funtion_3:",self.funtion_3)
    ...
    def memoryAccess(self):
        ...
        Now we will decide the condition using muxY value
...
class pipelineExecute :
    ...
    def DecodeR(self):
        ...
        self.Source_reg_2 = self.instruction[7:12]
        ...
        if self.Source_reg_2 in self.RDQueue or self.source_reg_1 in self.RDQueue :    #checking if rs1 and Source_reg_2 are in being used as rd for some other instruction

            if self.do_dataForwarding== 1:
                print("       Data hazard detected in the cycle\n  ")
                ...
                print("       Data forwarding disabled. Stall is taken\n")
    ...
    def DecodeI(self) :
        ...
        if self.OP_code == "0000011":
            if(self.funtion_3 == "000" or self.funtion_3 == "001" or self.funtion_3 == "010"  or self.funtion_3 == "100" or self.funtion_3 == "101" ):
                    ...
                    '''
                    Going to particular load instruction
                    '''
    ...
    def DecodeS(self) :
        ...
        if self.Source_reg_2 in self.RDQueue or self.source_reg_1 in self.RDQueue :
    ...
    def DecodeSB(self) :
        ...
        if self.Source_reg_2 in self.RDQueue or self.source_reg_1 in self.RDQueue:
            if self.do_dataForwarding==1:
                ...
                ''' check if Source_reg_2 is first or not
                '''
                if self.Source_reg_2 == first:
                    self.old_data_hazard = 1
                    self.RB = self.RZ
                ...
                try:
                    ...
                    '''
                    if first != second:
                        '''Check if value of Source_reg_2 is equal to second or not
                        '''
                        if self.Source_reg_2 == second:
                            self.old_data_hazard = 1
                            self.RB = self.RY
    ...
    def DecodeU(self) :
        ...
        Destination register is appended to RDQueue
