...
def Run_program(choice,i_cache_size,i_block_size,i_ways,d_cache_size,d_block_size,d_ways):
    ...
    if choice == 1:
        ...
        if (MC != ""):
            ...
            instructioncache= Execute.Instruction_cache.returns()
            with open('instructioncache.txt','w') as outfile:
                json.dump(instructioncache,outfile,indent=4)
            datacache= Execute.Data_cache.returns()
            with open('datacache.txt','w') as outfile:
                json.dump(datacache,outfile,indent=4)
        ...
        # except:
        # print("Input Valid mc code")
    with open('register.mc','w') as f:
        json.dump(Execute.Register.returns(),f,indent=4)
